...
genai_client = genai.Client(api_key="AIzaSyDIXlLcWeZRfG86FBjCnham1ntYfchaeG8")

# Groq models
from groq import Groq
groq_client = Groq(api_key="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")
